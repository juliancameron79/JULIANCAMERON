      ...
      <div className="container pt-4">
        <div className="row">
          ...
          <div className="col-lg-6 col-sm-12" data-aos="fade" data-aos-delay="50" data-aos-duration="2000" data-aos-once="true">
            ...
            <p className="about-text">I’m a recently qualified Full Stack Software Developer living in Viksjö. I enjoy working with and adapting to technologies as they develop. I'm quietly confident, naturally curious, and perpetually working on improving my chops one design problem at a time.</p>
